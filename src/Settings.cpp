...
namespace Settings {
  ...
  void _loadDefaults() {
    ...
    strcpy(settings.ap_ssid, DEFAULTS_HUMAN_NAME);
  }
  ...
  String getDeviceId() { return String(settings.human_name) + "_" + String(ESP.getChipId(), HEX); }
  ...
  String getInfoJson() {
    String info = "{\"ssid\":\"" + String(settings.ssid) + "\",\"ap_ssid\":\"" + String(settings.ap_ssid) +
                  "\",\"human_name\":\"" + String(settings.human_name) + "\",\"announce_topic\":\"" +
                  String(settings.announce_topic) + "\",\"device_id\":\"" + String(getDeviceId()) + "\",\"broker\":\"" +
                  String(settings.broker) + "\",\"topic\":\"" + String(settings.topic) + "\",\"build\":\"" + VERSION +
